...
│  sha256: <cassi_principle_hash>  (immutable once committed)          │
├────────┬───────────────────────────────────────────────────────────────────┤
│   E    │ FORWARD MODEL                                                    │
│        │                                                                  │
...
```yaml
# cassi/fluocells_mismatch_only.yaml
# Layer 2 output — references the Cassi Principle

principle_ref: sha256:<cassi_principle_hash>   # ← links to Layer 1
...
```yaml
# cassi/fluocells_oracle_assisted.yaml

principle_ref: sha256:<cassi_principle_hash>
...
type:            "I-benchmark"
spec_ref:        "sha256:<cassi_spec1_hash>"       # mismatch-only spec
principle_ref:   "sha256:<cassi_principle_hash>"
...
dataset_hash:    "sha256:<cassi_dataset_hash>"
generator_hash:  "sha256:<cassi_gen_hash>"
...
```bash
pwm-node verify cassi/fluocells_t1_nominal.yaml
```
...
```bash
pwm-node mine cassi/fluocells_t1_nominal.yaml
```
...
{
  "cert_hash": "sha256:...",
  "h_s": "sha256:<cassi_spec1_hash>",
  "h_b": "sha256:<cassi_bench1_hash>",
  "h_p": "sha256:<cassi_principle_hash>",
...
```
cert references:
  h_p → Principle  sha256:<cassi_principle_hash>   (Layer 1, immutable)
  h_s → spec.md    sha256:<cassi_spec1_hash>       (Layer 2, immutable)
  h_b → Benchmark  sha256:<cassi_bench1_hash>      (Layer 3, immutable)
  h_x → Solution   sha256:<cassi_solution_hash>    (Layer 4, this submission)
```
...
```
Layer 1 ──→ Principle sha256:<cassi_principle_hash>     FIXED
               │
Layer 2 ──→ spec.md sha256:<cassi_spec1_hash>           FIXED
               │   contains: principle_ref: sha256:<cassi_principle_hash>
               │
Layer 3 ──→ Benchmark sha256:<cassi_bench1_hash>        FIXED
               │   contains: spec_ref: sha256:<cassi_spec1_hash>
               │             principle_ref: sha256:<cassi_principle_hash>
               │
Layer 4 ──→ Certificate sha256:<cassi_cert_hash>        SUBMITTED
                   contains: h_s: sha256:<cassi_spec1_hash>
                             h_b: sha256:<cassi_bench1_hash>
                             h_p: sha256:<cassi_principle_hash>
                             h_x: sha256:<cassi_solution_hash>
...
```bash
pwm-node mine cassi/fluocells_mismatch_only_t1_nominal.yaml
```
...
pwm-node mine cassi/oracle_t1_h128_pix100.yaml
...
|-------|------------------|
| Cassi Principle (#1) | `principle.md`, Section A (Microscopy) |
