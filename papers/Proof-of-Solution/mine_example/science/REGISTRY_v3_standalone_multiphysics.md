...
| L1-504 | Quantitative Photoacoustic Tomography (qPAT) | `C_medical_imaging/` | optical ⊗ thermoelastic ⊗ acoustic | 2 | ~7-9 | Pending |
...
| _TBD_ | L1-504 qPAT authored; row moves from Pending to Authored. |
